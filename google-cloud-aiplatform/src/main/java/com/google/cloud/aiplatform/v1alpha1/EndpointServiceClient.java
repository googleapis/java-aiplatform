...
import com.google.cloud.aiplatform.v1alpha1.stub.EndpointServiceStub;
import com.google.cloud.aiplatform.v1alpha1.stub.EndpointServiceStubSettings;
...
public class EndpointServiceClient implements BackgroundResource {
   ...
   * for advanced usage - prefer to use EndpointServiceSettings}.
   */
   ...
   *     [Endpoint.traffic_split][google.cloud.aiplatform.v1alpha1.Endpoint.traffic_split] must be
   *     updated for the DeployedModel to start receiving traffic, either as part of this call, or
   *     via
   *     [EndpointService.UpdateEndpoint][google.cloud.aiplatform.v1alpha1.EndpointService.UpdateEndpoint].
   * @param trafficSplit If this field is non-empty, then the Endpoint's
   *     [traffic_split][google.cloud.aiplatform.v1alpha1.Endpoint.traffic_split] will be
   *     overwritten with it. To refer to the ID of the just being deployed Model, a "0" should be
   *     used, and the actual ID of the new DeployedModel will be filled in its place by this
   *     method. If this field is empty, then the Endpoint's
   *     [traffic_split][google.cloud.aiplatform.v1alpha1.Endpoint.traffic_split] is not updated.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  @BetaApi(
      "The surface for long-running operations is not stable yet and may change in the future.")
   ...
   *     [traffic_split][google.cloud.aiplatform.v1alpha1.Endpoint.traffic_split] will be
   *     overwritten with it. If last DeployedModel is being undeployed from the Endpoint, the
