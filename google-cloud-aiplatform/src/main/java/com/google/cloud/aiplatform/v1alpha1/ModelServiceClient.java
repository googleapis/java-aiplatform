...
import com.google.cloud.aiplatform.v1alpha1.stub.ModelServiceStub;
import com.google.cloud.aiplatform.v1alpha1.stub.ModelServiceStubSettings;
...
public class ModelServiceClient implements BackgroundResource {
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD
  /**
   * Exports a trained, "export-able", Model to a location specified by the user. A Model is
   * considered export-able if it has at least one [supported export
   * format][Model.supported_export_formats].
   *
   * <p>Sample code:
   *
   * <pre><code>
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD
  /**
   * Exports DataItems on which the Model was evaluated (i.e. which were in the TEST set of the
   * dataset the Model was created from), together with their ground truth Annotations and the
   * predictions predicted by the Model.
   *
   * <p>The DataItems, ground truth Annotations and predictions are exported in the state they were
   * at the moment the Model was evaluated.
   *
   * <p>This export is available only for 30 days since the ModelEvaluation is created.
   *
   * <p>Currently only available for AutoML Tables Models.
   *
   * <p>Sample code:
   *
   * <pre><code>
   * try (ModelServiceClient modelServiceClient = ModelServiceClient.create()) {
   *   ModelEvaluationName modelEvaluation = ModelEvaluationName.of("[PROJECT]", "[LOCATION]", "[MODEL]", "[EVALUATION]");
   *   ExportEvaluatedDataItemsOperationResponse response = modelServiceClient.exportEvaluatedDataItemsAsync(modelEvaluation).get();
   * }
   * </code></pre>
   *
   * @param modelEvaluation Required. The resource name of the ModelEvaluation whose evaluated
   *     DataItems are to be exported. Format:
   *     <p>`projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}`
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  @BetaApi(
  ...
  public final OperationFuture<
          ExportEvaluatedDataItemsOperationResponse, ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsAsync(ModelEvaluationName modelEvaluation) {
    ExportEvaluatedDataItemsRequest request =
        ExportEvaluatedDataItemsRequest.newBuilder()
            .setModelEvaluation(modelEvaluation == null ? null : modelEvaluation.toString())
            .build();
    return exportEvaluatedDataItemsAsync(request);
  }
   ...
   * try (ModelServiceClient modelServiceClient = ModelServiceClient.create()) {
   *   ModelEvaluationName modelEvaluation = ModelEvaluationName.of("[PROJECT]", "[LOCATION]", "[MODEL]", "[EVALUATION]");
   *   ExportEvaluatedDataItemsOperationResponse response = modelServiceClient.exportEvaluatedDataItemsAsync(modelEvaluation.toString()).get();
   * }
   * </code></pre>
   *
   * @param modelEvaluation Required. The resource name of the ModelEvaluation whose evaluated
  ...
  public final OperationFuture<
          ExportEvaluatedDataItemsOperationResponse, ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsAsync(String modelEvaluation) {
    ExportEvaluatedDataItemsRequest request =
        ExportEvaluatedDataItemsRequest.newBuilder().setModelEvaluation(modelEvaluation).build();
    return exportEvaluatedDataItemsAsync(request);
  }
   ...
   * try (ModelServiceClient modelServiceClient = ModelServiceClient.create()) {
   *   ModelEvaluationName modelEvaluation = ModelEvaluationName.of("[PROJECT]", "[LOCATION]", "[MODEL]", "[EVALUATION]");
   *   ExportEvaluatedDataItemsRequest.OutputConfig outputConfig = ExportEvaluatedDataItemsRequest.OutputConfig.newBuilder().build();
   *   ExportEvaluatedDataItemsRequest request = ExportEvaluatedDataItemsRequest.newBuilder()
   *     .setModelEvaluation(modelEvaluation.toString())
   *     .setOutputConfig(outputConfig)
   *     .build();
   *   ExportEvaluatedDataItemsOperationResponse response = modelServiceClient.exportEvaluatedDataItemsAsync(request).get();
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
  ...
  public final OperationFuture<
          ExportEvaluatedDataItemsOperationResponse, ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsAsync(ExportEvaluatedDataItemsRequest request) {
    return exportEvaluatedDataItemsOperationCallable().futureCall(request);
  }
   ...
   *     .setOutputConfig(outputConfig)
   *     .build();
   *   OperationFuture&lt;ExportEvaluatedDataItemsOperationResponse, ExportEvaluatedDataItemsOperationMetadata&gt; future = modelServiceClient.exportEvaluatedDataItemsOperationCallable().futureCall(request);
   *   // Do something
   *   ExportEvaluatedDataItemsOperationResponse response = future.get();
   * }
   * </code></pre>
   */
  @BetaApi("The surface for use by generated code is not stable yet and may change in the future.")
  public final OperationCallable<
    ...
    return stub.exportEvaluatedDataItemsOperationCallable();
  }
   ...
   *     .setOutputConfig(outputConfig)
   *     .build();
   *   ApiFuture&lt;Operation&gt; future = modelServiceClient.exportEvaluatedDataItemsCallable().futureCall(request);
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   */
  public final UnaryCallable<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsCallable() {
    return stub.exportEvaluatedDataItemsCallable();
  }
