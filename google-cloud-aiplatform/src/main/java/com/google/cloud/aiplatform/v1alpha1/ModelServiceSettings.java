...
public class ModelServiceSettings extends ClientSettings<ModelServiceSettings> {
  ...
  public UnaryCallSettings<ExportEvaluatedDataItemsRequest, Operation>
    ...
    return ((ModelServiceStubSettings) getStubSettings()).exportEvaluatedDataItemsSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<ModelServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<ExportEvaluatedDataItemsRequest, Operation>
        exportEvaluatedDataItemsSettings() {
      return getStubSettingsBuilder().exportEvaluatedDataItemsSettings();
    }
    ...
    public OperationCallSettings.Builder<
            ...
            ExportEvaluatedDataItemsOperationMetadata>
        exportEvaluatedDataItemsOperationSettings() {
      return getStubSettingsBuilder().exportEvaluatedDataItemsOperationSettings();
    }
