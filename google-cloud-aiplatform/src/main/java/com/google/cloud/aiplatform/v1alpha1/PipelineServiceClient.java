...
import com.google.cloud.aiplatform.v1alpha1.stub.PipelineServiceStub;
import com.google.cloud.aiplatform.v1alpha1.stub.PipelineServiceStubSettings;
...
public class PipelineServiceClient implements BackgroundResource {
   ...
   * [TrainingPipeline.error][google.cloud.aiplatform.v1alpha1.TrainingPipeline.error] value with a
   * [google.rpc.Status.code][google.rpc.Status.code] of 1, corresponding to `Code.CANCELLED`, and
   * [TrainingPipeline.state][google.cloud.aiplatform.v1alpha1.TrainingPipeline.state] is set to
   * `CANCELLED`.
   *
   * <p>Sample code:
   *
