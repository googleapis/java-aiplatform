...
import com.google.cloud.aiplatform.v1alpha1.stub.PredictionServiceStub;
import com.google.cloud.aiplatform.v1alpha1.stub.PredictionServiceStubSettings;
...
public class PredictionServiceClient implements BackgroundResource {
   ...
   *     [Model's][google.cloud.aiplatform.v1alpha1.DeployedModel.model]
   ...
   *     ][google.cloud.aiplatform.v1alpha1.DeployedModel.model]
   *     [PredictSchemata's][google.cloud.aiplatform.v1alpha1.Model.predict_schemata]
   ...
   *     [Endpoint.traffic_split][google.cloud.aiplatform.v1alpha1.Endpoint.traffic_split].
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
