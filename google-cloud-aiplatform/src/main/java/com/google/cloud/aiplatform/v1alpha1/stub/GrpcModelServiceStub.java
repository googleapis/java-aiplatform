...
import static com.google.cloud.aiplatform.v1alpha1.ModelServiceClient.ListModelEvaluationSlicesPagedResponse;
import static com.google.cloud.aiplatform.v1alpha1.ModelServiceClient.ListModelEvaluationsPagedResponse;
import static com.google.cloud.aiplatform.v1alpha1.ModelServiceClient.ListModelsPagedResponse;
...
import com.google.cloud.aiplatform.v1alpha1.DeleteModelRequest;
import com.google.cloud.aiplatform.v1alpha1.DeleteOperationMetadata;
import com.google.cloud.aiplatform.v1alpha1.ExportEvaluatedDataItemsOperationMetadata;
import com.google.cloud.aiplatform.v1alpha1.ExportEvaluatedDataItemsOperationResponse;
import com.google.cloud.aiplatform.v1alpha1.ExportEvaluatedDataItemsRequest;
import com.google.cloud.aiplatform.v1alpha1.ExportModelOperationMetadata;
import com.google.cloud.aiplatform.v1alpha1.ExportModelRequest;
import com.google.cloud.aiplatform.v1alpha1.ExportModelResponse;
import com.google.cloud.aiplatform.v1alpha1.GetModelEvaluationRequest;
import com.google.cloud.aiplatform.v1alpha1.GetModelEvaluationSliceRequest;
import com.google.cloud.aiplatform.v1alpha1.GetModelRequest;
import com.google.cloud.aiplatform.v1alpha1.ListModelEvaluationSlicesRequest;
import com.google.cloud.aiplatform.v1alpha1.ListModelEvaluationSlicesResponse;
import com.google.cloud.aiplatform.v1alpha1.ListModelEvaluationsRequest;
import com.google.cloud.aiplatform.v1alpha1.ListModelEvaluationsResponse;
import com.google.cloud.aiplatform.v1alpha1.ListModelsRequest;
import com.google.cloud.aiplatform.v1alpha1.ListModelsResponse;
import com.google.cloud.aiplatform.v1alpha1.Model;
import com.google.cloud.aiplatform.v1alpha1.ModelEvaluation;
import com.google.cloud.aiplatform.v1alpha1.ModelEvaluationSlice;
import com.google.cloud.aiplatform.v1alpha1.UploadModelOperationMetadata;
import com.google.cloud.aiplatform.v1alpha1.UploadModelRequest;
import com.google.cloud.aiplatform.v1alpha1.UploadModelResponse;
...
public class GrpcModelServiceStub extends ModelServiceStub {
  ...
  private static final MethodDescriptor<UploadModelRequest, Operation> uploadModelMethodDescriptor =
      MethodDescriptor.<UploadModelRequest, Operation>newBuilder()
          ...
          .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/UploadModel")
  ...
  private static final MethodDescriptor<GetModelRequest, Model> getModelMethodDescriptor =
      MethodDescriptor.<GetModelRequest, Model>newBuilder()
          .setType(MethodDescriptor.MethodType.UNARY)
          .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/GetModel")
  ...
  private static final MethodDescriptor<ListModelsRequest, ListModelsResponse>
      listModelsMethodDescriptor =
          MethodDescriptor.<ListModelsRequest, ListModelsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/ListModels")
  ...
  private static final MethodDescriptor<DeleteModelRequest, Operation> deleteModelMethodDescriptor =
      MethodDescriptor.<DeleteModelRequest, Operation>newBuilder()
          .setType(MethodDescriptor.MethodType.UNARY)
          .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/DeleteModel")
  ...
  private static final MethodDescriptor<ExportModelRequest, Operation> exportModelMethodDescriptor =
      MethodDescriptor.<ExportModelRequest, Operation>newBuilder()
          .setType(MethodDescriptor.MethodType.UNARY)
          .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/ExportModel")
  ...
  private static final MethodDescriptor<GetModelEvaluationRequest, ModelEvaluation>
      getModelEvaluationMethodDescriptor =
          MethodDescriptor.<GetModelEvaluationRequest, ModelEvaluation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.aiplatform.v1alpha1.ModelService/GetModelEvaluation")
  ...
  private static final MethodDescriptor<ListModelEvaluationsRequest, ListModelEvaluationsResponse>
      listModelEvaluationsMethodDescriptor =
          MethodDescriptor.<ListModelEvaluationsRequest, ListModelEvaluationsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.aiplatform.v1alpha1.ModelService/ListModelEvaluations")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<GetModelEvaluationSliceRequest, ModelEvaluationSlice>
      getModelEvaluationSliceMethodDescriptor =
          MethodDescriptor.<GetModelEvaluationSliceRequest, ModelEvaluationSlice>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.aiplatform.v1alpha1.ModelService/GetModelEvaluationSlice")
              .setRequestMarshaller(
  ...
  private static final MethodDescriptor<
      ...
      listModelEvaluationSlicesMethodDescriptor =
          MethodDescriptor
              ...
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.aiplatform.v1alpha1.ModelService/ListModelEvaluationSlices")
              .setRequestMarshaller(
              ...
              .build();
  private static final MethodDescriptor<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsMethodDescriptor =
          MethodDescriptor.<ExportEvaluatedDataItemsRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.aiplatform.v1alpha1.ModelService/ExportEvaluatedDataItems")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(ExportEvaluatedDataItemsRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
              .build();
  ...
  private final UnaryCallable<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsCallable;
  private final OperationCallable<
          ExportEvaluatedDataItemsRequest,
          ExportEvaluatedDataItemsOperationResponse,
          ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsOperationCallable;
  ...
  protected GrpcModelServiceStub(
    ...
    GrpcCallSettings<ListModelEvaluationSlicesRequest, ListModelEvaluationSlicesResponse>
        listModelEvaluationSlicesTransportSettings =
            GrpcCallSettings
                ...
                .build();
    GrpcCallSettings<ExportEvaluatedDataItemsRequest, Operation>
        exportEvaluatedDataItemsTransportSettings =
            GrpcCallSettings.<ExportEvaluatedDataItemsRequest, Operation>newBuilder()
                .setMethodDescriptor(exportEvaluatedDataItemsMethodDescriptor)
                .setParamsExtractor(
                    new RequestParamsExtractor<ExportEvaluatedDataItemsRequest>() {
                      @Override
                      public Map<String, String> extract(ExportEvaluatedDataItemsRequest request) {
                        ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                        params.put(
                            "model_evaluation", String.valueOf(request.getModelEvaluation()));
                        return params.build();
                      }
                    })
                .build();
    ...
    this.listModelEvaluationSlicesPagedCallable =
        callableFactory.createPagedCallable(
            ...
            settings.listModelEvaluationSlicesSettings(),
            clientContext);
    this.exportEvaluatedDataItemsCallable =
        callableFactory.createUnaryCallable(
            exportEvaluatedDataItemsTransportSettings,
            settings.exportEvaluatedDataItemsSettings(),
            clientContext);
    this.exportEvaluatedDataItemsOperationCallable =
        callableFactory.createOperationCallable(
            exportEvaluatedDataItemsTransportSettings,
            settings.exportEvaluatedDataItemsOperationSettings(),
            clientContext,
            this.operationsStub);
  ...
  public OperationCallable<
          ...
          ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsOperationCallable() {
    return exportEvaluatedDataItemsOperationCallable;
  }

  public UnaryCallable<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsCallable() {
    return exportEvaluatedDataItemsCallable;
  }
