...
public class ModelServiceStubSettings extends StubSettings<ModelServiceStubSettings> {
  ...
  private final UnaryCallSettings<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsSettings;
  private final OperationCallSettings<
          ExportEvaluatedDataItemsRequest,
          ExportEvaluatedDataItemsOperationResponse,
          ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsOperationSettings;
  ...
  /** Returns the object with the settings used for calls to exportEvaluatedDataItems. */
  public UnaryCallSettings<ExportEvaluatedDataItemsRequest, Operation>
      exportEvaluatedDataItemsSettings() {
    return exportEvaluatedDataItemsSettings;
  }
  ...
  public OperationCallSettings<
          ...
          ExportEvaluatedDataItemsOperationMetadata>
      exportEvaluatedDataItemsOperationSettings() {
    return exportEvaluatedDataItemsOperationSettings;
  }
  ...
  protected ModelServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    exportEvaluatedDataItemsSettings = settingsBuilder.exportEvaluatedDataItemsSettings().build();
    exportEvaluatedDataItemsOperationSettings =
        settingsBuilder.exportEvaluatedDataItemsOperationSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<ModelServiceStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<
            ...
            ListModelEvaluationSlicesPagedResponse>
        listModelEvaluationSlicesSettings;
    private final UnaryCallSettings.Builder<ExportEvaluatedDataItemsRequest, Operation>
        exportEvaluatedDataItemsSettings;
    private final OperationCallSettings.Builder<
            ExportEvaluatedDataItemsRequest,
            ExportEvaluatedDataItemsOperationResponse,
    ...
    protected Builder(ClientContext clientContext) {
      ...
      exportEvaluatedDataItemsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      exportEvaluatedDataItemsOperationSettings = OperationCallSettings.newBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<ExportEvaluatedDataItemsRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("non_idempotent"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("default"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(
                  ExportEvaluatedDataItemsOperationResponse.class))
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.create(
                  ExportEvaluatedDataItemsOperationMetadata.class))
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
                  RetrySettings.newBuilder()
                      .setInitialRetryDelay(Duration.ofMillis(500L))
    ...
    protected Builder(ModelServiceStubSettings settings) {
      ...
      exportEvaluatedDataItemsSettings = settings.exportEvaluatedDataItemsSettings.toBuilder();
      exportEvaluatedDataItemsOperationSettings =
          settings.exportEvaluatedDataItemsOperationSettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to exportEvaluatedDataItems. */
    public UnaryCallSettings.Builder<ExportEvaluatedDataItemsRequest, Operation>
        exportEvaluatedDataItemsSettings() {
      return exportEvaluatedDataItemsSettings;
    }
