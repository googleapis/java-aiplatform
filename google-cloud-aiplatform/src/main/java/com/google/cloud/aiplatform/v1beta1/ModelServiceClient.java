...
public class ModelServiceClient implements BackgroundResource {
   ...
   *     version alias. Example: projects/{project}/locations/{location}/models/{model}{@literal @}2
   *     or projects/{project}/locations/{location}/models/{model}{@literal @}golden If no version
   *     ID or alias is specified, the "default" version will be returned. The "default" version
   *     alias is created for the first version of the model, and can be moved to other versions
   *     later on. There will be exactly one default version.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
