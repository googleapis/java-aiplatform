...
import com.google.cloud.aiplatform.v1alpha1.ModelServiceGrpc.ModelServiceImplBase;
...
public class MockModelServiceImpl extends ModelServiceImplBase {
  ...
  public void exportEvaluatedDataItems(
      ExportEvaluatedDataItemsRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.remove();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext((Operation) response);
