...
public final class BatchPredictionJobProto {
  ...
  static {
    ...
    internal_static_google_cloud_aiplatform_v1_BatchPredictionJob_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1_BatchPredictionJob_descriptor,
        new java.lang.String[] { "Name", "DisplayName", "Model", "InputConfig", "ModelParameters", "OutputConfig", "DedicatedResources", "ManualBatchTuningParameters", "OutputInfo", "State", "Error", "PartialFailures", "ResourcesConsumed", "CompletionStats", "CreateTime", "StartTime", "EndTime", "UpdateTime", "Labels", "EncryptionSpec", });
    internal_static_google_cloud_aiplatform_v1_BatchPredictionJob_InputConfig_descriptor =
