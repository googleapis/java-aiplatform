      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            trial_ = input.readMessage(com.google.cloud.aiplatform.v1.Trial.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1.CreateTrialRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeTrial(com.google.cloud.aiplatform.v1.Trial value) {
      if (trialBuilder_ == null) {
        if (trial_ != null) {
          trial_ =
            com.google.cloud.aiplatform.v1.Trial.newBuilder(trial_).mergeFrom(value).buildPartial();
        } else {
          trial_ = value;
        }
        onChanged();
