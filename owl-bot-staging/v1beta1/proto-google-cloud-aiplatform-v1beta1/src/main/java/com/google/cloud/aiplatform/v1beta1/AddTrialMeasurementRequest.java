      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            measurement_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.Measurement.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.AddTrialMeasurementRequest) e.getUnfinishedMessage();
