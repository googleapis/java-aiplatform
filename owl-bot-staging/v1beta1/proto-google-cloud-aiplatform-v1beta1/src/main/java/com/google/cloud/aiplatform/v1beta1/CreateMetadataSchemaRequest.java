      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            metadataSchema_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.MetadataSchema.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.CreateMetadataSchemaRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeMetadataSchema(com.google.cloud.aiplatform.v1beta1.MetadataSchema value) {
      if (metadataSchemaBuilder_ == null) {
        if (metadataSchema_ != null) {
          metadataSchema_ =
            com.google.cloud.aiplatform.v1beta1.MetadataSchema.newBuilder(metadataSchema_).mergeFrom(value).buildPartial();
        } else {
          metadataSchema_ = value;
        }
        onChanged();
