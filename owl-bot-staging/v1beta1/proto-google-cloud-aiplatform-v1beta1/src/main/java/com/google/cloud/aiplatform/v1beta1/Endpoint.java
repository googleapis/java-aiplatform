    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 146: {
            com.google.cloud.aiplatform.v1beta1.PredictRequestResponseLoggingConfig.Builder subBuilder = null;
            if (predictRequestResponseLoggingConfig_ != null) {
              subBuilder = predictRequestResponseLoggingConfig_.toBuilder();
            }
            predictRequestResponseLoggingConfig_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.PredictRequestResponseLoggingConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
