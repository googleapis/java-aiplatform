...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            com.google.cloud.aiplatform.v1beta1.Preset.Builder subBuilder = null;
            if (configCase_ == 4) {
              subBuilder = ((com.google.cloud.aiplatform.v1beta1.Preset) config_).toBuilder();
            }
            config_ =
                input.readMessage(com.google.cloud.aiplatform.v1beta1.Preset.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.aiplatform.v1beta1.Preset) config_);
              config_ = subBuilder.buildPartial();
            }
            configCase_ = 4;
            break;
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Preset preset = 4;</code>
   ...
   */
  @java.lang.Override
  public com.google.cloud.aiplatform.v1beta1.Preset getPreset() {
    if (configCase_ == 4) {
       return (com.google.cloud.aiplatform.v1beta1.Preset) config_;
    }
   ...
   */
  @java.lang.Override
  public com.google.cloud.aiplatform.v1beta1.PresetOrBuilder getPresetOrBuilder() {
    if (configCase_ == 4) {
       return (com.google.cloud.aiplatform.v1beta1.Preset) config_;
    }
    return com.google.cloud.aiplatform.v1beta1.Preset.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (configCase_ == 4) {
      output.writeMessage(4, (com.google.cloud.aiplatform.v1beta1.Preset) config_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (configCase_ == 4) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, (com.google.cloud.aiplatform.v1beta1.Preset) config_);
    }
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.aiplatform.v1beta1.Examples buildPartial() {
      ...
      if (configCase_ == 4) {
        if (presetBuilder_ == null) {
          ...
          result.config_ = presetBuilder_.build();
        }
      }
      if (gcsSourceBuilder_ == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.aiplatform.v1beta1.Preset, com.google.cloud.aiplatform.v1beta1.Preset.Builder, com.google.cloud.aiplatform.v1beta1.PresetOrBuilder> presetBuilder_;
    /**
     * <pre>
     * Preset config based on the desired query speed-precision trade-off
     * and modality
     ...
     * <code>.google.cloud.aiplatform.v1beta1.Preset preset = 4;</code>
     */
    public Builder setPreset(com.google.cloud.aiplatform.v1beta1.Preset value) {
      if (presetBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setPreset(
        com.google.cloud.aiplatform.v1beta1.Preset.Builder builderForValue) {
      if (presetBuilder_ == null) {
        config_ = builderForValue.build();
        onChanged();
      } else {
     ...
     * <code>.google.cloud.aiplatform.v1beta1.Preset preset = 4;</code>
     */
    public Builder mergePreset(com.google.cloud.aiplatform.v1beta1.Preset value) {
      if (presetBuilder_ == null) {
        if (configCase_ == 4 &&
            config_ != com.google.cloud.aiplatform.v1beta1.Preset.getDefaultInstance()) {
          config_ = com.google.cloud.aiplatform.v1beta1.Preset.newBuilder((com.google.cloud.aiplatform.v1beta1.Preset) config_)
              .mergeFrom(value).buildPartial();
        } else {
          config_ = value;
        }
     ...
     * <code>.google.cloud.aiplatform.v1beta1.Preset preset = 4;</code>
     */
    public com.google.cloud.aiplatform.v1beta1.Preset.Builder getPresetBuilder() {
    ...
    @java.lang.Override
    public com.google.cloud.aiplatform.v1beta1.PresetOrBuilder getPresetOrBuilder() {
      if ((configCase_ == 4) && (presetBuilder_ != null)) {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.aiplatform.v1beta1.Preset, com.google.cloud.aiplatform.v1beta1.Preset.Builder, com.google.cloud.aiplatform.v1beta1.PresetOrBuilder> 
      ...
      if (presetBuilder_ == null) {
        ...
        presetBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.aiplatform.v1beta1.Preset, com.google.cloud.aiplatform.v1beta1.Preset.Builder, com.google.cloud.aiplatform.v1beta1.PresetOrBuilder>(
                (com.google.cloud.aiplatform.v1beta1.Preset) config_,
                getParentForChildren(),
                isClean());
        config_ = null;
      }
