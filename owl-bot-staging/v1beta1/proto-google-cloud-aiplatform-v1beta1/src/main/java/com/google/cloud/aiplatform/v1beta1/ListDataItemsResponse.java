        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              dataItems_ = new java.util.ArrayList<com.google.cloud.aiplatform.v1beta1.DataItem>();
              mutable_bitField0_ |= 0x00000001;
            }
            dataItems_.add(
                input.readMessage(com.google.cloud.aiplatform.v1beta1.DataItem.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.ListDataItemsResponse) e.getUnfinishedMessage();
