        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              specialistPools_ = new java.util.ArrayList<com.google.cloud.aiplatform.v1beta1.SpecialistPool>();
              mutable_bitField0_ |= 0x00000001;
            }
            specialistPools_.add(
                input.readMessage(com.google.cloud.aiplatform.v1beta1.SpecialistPool.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.ListSpecialistPoolsResponse) e.getUnfinishedMessage();
