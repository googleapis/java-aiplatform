...
public interface BatchPredictionJobOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1alpha1.BatchPredictionJob)
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.BatchPredictionJob.InputConfig getInputConfig();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.BatchPredictionJob.OutputConfig getOutputConfig();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.BatchDedicatedResources getDedicatedResources();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.ManualBatchTuningParameters getManualBatchTuningParameters();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.BatchPredictionJob.OutputInfo getOutputInfo();
  /**
   *
   *
   * <pre>
   ...
   * @return The state.
   */
  com.google.cloud.aiplatform.v1alpha1.JobState getState();
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.ResourcesConsumed getResourcesConsumed();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.ResourcesConsumedOrBuilder getResourcesConsumedOrBuilder();
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.CompletionStats getCompletionStats();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.CompletionStatsOrBuilder getCompletionStatsOrBuilder();
