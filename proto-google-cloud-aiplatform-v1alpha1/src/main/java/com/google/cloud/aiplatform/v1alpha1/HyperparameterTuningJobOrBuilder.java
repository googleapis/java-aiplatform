...
public interface HyperparameterTuningJobOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1alpha1.HyperparameterTuningJob)
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.StudySpec getStudySpec();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.StudySpecOrBuilder getStudySpecOrBuilder();
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.CustomJobSpec getTrialJobSpec();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.CustomJobSpecOrBuilder getTrialJobSpecOrBuilder();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1alpha1.Trial> getTrialsList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.Trial getTrials(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1alpha1.TrialOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.TrialOrBuilder getTrialsOrBuilder(int index);
