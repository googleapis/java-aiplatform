...
public interface ModelEvaluationSliceOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1alpha1.ModelEvaluationSlice)
   ...
   * @return The slice.
   */
  com.google.cloud.aiplatform.v1alpha1.ModelEvaluationSlice.Slice getSlice();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1alpha1.ModelEvaluationSlice.SliceOrBuilder getSliceOrBuilder();
