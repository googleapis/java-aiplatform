...
public interface TrainingPipelineOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1alpha1.TrainingPipeline)
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.InputDataConfig getInputDataConfig();
  /**
   *
   *
   * <pre>
   ...
   * <code>.google.cloud.aiplatform.v1alpha1.InputDataConfig input_data_config = 3;</code>
   */
  com.google.cloud.aiplatform.v1alpha1.InputDataConfigOrBuilder getInputDataConfigOrBuilder();
   ...
   */
  com.google.cloud.aiplatform.v1alpha1.Model getModelToUpload();
  /**
   *
   *
   * <pre>
   ...
   * <code>.google.cloud.aiplatform.v1alpha1.Model model_to_upload = 7;</code>
   */
  com.google.cloud.aiplatform.v1alpha1.ModelOrBuilder getModelToUploadOrBuilder();
   ...
   * @return The state.
   */
  com.google.cloud.aiplatform.v1alpha1.PipelineState getState();
