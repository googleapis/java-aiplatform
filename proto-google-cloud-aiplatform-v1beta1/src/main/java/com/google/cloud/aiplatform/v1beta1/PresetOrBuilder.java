...
public interface PresetOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.Preset)
   ...
   * @return The query.
   */
  com.google.cloud.aiplatform.v1beta1.Preset.Query getQuery();
   ...
   * @return The modality.
   */
  com.google.cloud.aiplatform.v1beta1.Preset.Modality getModality();
}
