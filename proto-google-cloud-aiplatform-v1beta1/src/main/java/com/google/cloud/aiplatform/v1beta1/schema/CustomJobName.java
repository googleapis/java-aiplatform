...
public class CustomJobName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/customJobs/{custom_job}");
  ...
  public static CustomJobName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "CustomJobName.parse: formattedString not in valid format");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "location", location, "custom_job", customJob);
  }
