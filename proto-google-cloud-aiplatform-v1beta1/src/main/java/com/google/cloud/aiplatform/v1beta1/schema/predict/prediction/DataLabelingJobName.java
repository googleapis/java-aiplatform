...
public class DataLabelingJobName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/dataLabelingJobs/{data_labeling_job}");
  ...
  public static DataLabelingJobName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "DataLabelingJobName.parse: formattedString not in valid format");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "location", location, "data_labeling_job", dataLabelingJob);
  }
