...
public class ImportDataSample {
  ...
  public static void main(String[] args)
    ...
    String gcsSourceUri = "gs://YOUR_GCS_SOURCE_BUCKET/path_to_your_source/[file.csv/file.jsonl]";
    String importSchemaUri = "YOUR_IMPORT_SCHEMA_URI";
    importDataSample(project, datasetId, gcsSourceUri, importSchemaUri);
  }

  static void importDataSample(
      String project, String datasetId, String gcsSourceUri, String importSchemaUri)
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    try (DatasetServiceClient datasetServiceClient =
      ...
      System.out.format("Import Data Response: %s\n", importDataResponse);
    }
  }
}
