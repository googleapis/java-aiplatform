...
public class PredictTablesClassificationSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    predictTablesClassification(instance, project, endpointId);
  }

  static void predictTablesClassification(String instance, String project, String endpointId)
      throws IOException {
    ...
    try (PredictionServiceClient predictionServiceClient =
      ...
      System.out.println("Predict Tables Classification Response");
