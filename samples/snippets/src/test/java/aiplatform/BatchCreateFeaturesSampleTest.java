...
public class BatchCreateFeaturesSampleTest {
  ...
  private static final String ENTITY_TYPE_ID = "movies";
  ...
  @Test
  public void testBatchCreateFeaturesSampleSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    createEntityTypeSample(PROJECT_ID, featurestoreId, ENTITY_TYPE_ID, DESCRIPTION, LOCATION,
        ENDPOINT, TIMEOUT);
    ...
    BatchCreateFeaturesSample.batchCreateFeaturesSample(PROJECT_ID, featurestoreId, ENTITY_TYPE_ID,
