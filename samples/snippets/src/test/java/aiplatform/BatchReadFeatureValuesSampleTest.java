...
public class BatchReadFeatureValuesSampleTest {
  ...
  public void tearDown()
    ...
    deleteFeaturestoreSample(PROJECT_ID, featurestoreId, USE_FORCE, LOCATION, ENDPOINT, TIMEOUT);
  ...
  @Test
  public void testBatchReadFeatureValuesSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
