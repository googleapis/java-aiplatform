...
public class CreateEntityTypeMonitoringSampleTest {
  ...
  @Test
  public void testCreateEntityTypeMonitoringSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    CreateEntityTypeMonitoringSample.createEntityTypeMonitoringSample(PROJECT_ID, featurestoreId,
        entityTypeId, DESCRIPTION, MONITORING_INTERVAL_DAYS, LOCATION, ENDPOINT, TIMEOUT);

    // Assert
    String createEntityTypeResponse = bout.toString();
    assertThat(createEntityTypeResponse).contains("Create Entity Type Monitoring Response");
  }
