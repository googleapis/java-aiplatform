...
public class CreateSpecialistPoolSampleTest {
  ...
  @Test
  @Ignore("Avoid creating actual data labeling pool of humans")
  public void testCreateSpecialistPoolSampleTest() throws IOException {
    // Act
