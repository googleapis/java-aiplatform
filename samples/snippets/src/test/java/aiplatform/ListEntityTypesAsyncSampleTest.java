...
public class ListEntityTypesAsyncSampleTest {
  ...
  @Test
  public void testListEntityTypesAsyncSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    assertThat(listEntityTypeResponse).contains("List Entity Types Async Response");
  }
