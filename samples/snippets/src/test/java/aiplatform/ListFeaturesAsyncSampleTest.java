...
public class ListFeaturesAsyncSampleTest {
  ...
  @Test
  public void testListFeaturesAsyncSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    createFeaturestoreSample(PROJECT_ID, id, MIN_NODE_COUNT, MAX_NODE_COUNT, LOCATION,
        ENDPOINT, 900);
    ...
    assertThat(listfeatureResponse).contains("List Features Async Response");
  }
}
