...
public class ListFeaturesSampleTest {
  ...
  @Test
  public void testListFeaturesSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    // Assert
    String listfeaturesResponse = bout.toString();
    assertThat(listfeaturesResponse).contains("List Features Response");
  }
}
