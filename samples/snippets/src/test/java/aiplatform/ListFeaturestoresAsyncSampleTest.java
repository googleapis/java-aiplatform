...
public class ListFeaturestoresAsyncSampleTest {
  ...
  @Test
  public void testListFeaturestoresAsyncSample()
    ...
    assertThat(listFeaturestoresResponse).contains("List Featurestores Async Response");
  }
