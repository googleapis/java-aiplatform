...
public class SearchFeaturesAsyncSampleTest {

  private static final String PROJECT_ID = System.getenv("UCAIP_PROJECT_ID");
  private static final String QUERY = "feature_id:gender AND value_type=STRING";
  ...
  @Test
  public void testSearchFeaturesAsyncSample()
    ...
    assertThat(searchFeaturesResponse).contains("Search Features Async Response");
  }
