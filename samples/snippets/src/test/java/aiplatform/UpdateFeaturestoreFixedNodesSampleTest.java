...
public class UpdateFeaturestoreFixedNodesSampleTest {
  ...
  @Test
  public void testUpdateFeaturestoreSample()
      throws IOException, InterruptedException, ExecutionException, TimeoutException {
    ...
    createFeaturestoreFixedNodesSample(PROJECT_ID, id, FIXED_NODE_COUNT, LOCATION, ENDPOINT, 900);
